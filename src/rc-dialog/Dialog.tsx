...
export default class Dialog extends React.Component<IDialogPropTypes, any> {
    ...
    getDialogElement = () => {
        ...
        if (props.footer) {
            footer = (
                <div className={`${prefixCls}-footer`} ref={this.footerBind}>
                    {props.footer}
                </div>
            );
        }
        ...
        if (props.title) {
            header = (
                <div className={`${prefixCls}-header`} ref={this.headerBind}>
        ...
        const dialogElement = (
            ...
            >
                ...
                <div tabIndex={0} ref={this.sentinelBind} style={{width: 0, height: 0, overflow: 'hidden'}}>
                    sentinel
                </div>
            </LazyRenderBox>
        );
