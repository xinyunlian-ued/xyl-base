...
export default class Drawer extends Component<DrawerPropTypes, any> {
    ...
    renderStyle = ({sidebarStyle, isTouching, overlayStyle, contentStyle}: any) => {
    ...
    render() {
        const {
            className, style, prefixCls, position, transitions,
            touch, enableDragHandle, sidebar, children, docked, open
        } = this.props;
