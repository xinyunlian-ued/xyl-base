...
export default class InputNumber extends Component<InputNumberPropTypes, State> {
    ...
    componentWillUpdate() {
        try {
            this.start = this._input.selectionStart;
            this.end = this._input.selectionEnd;
        } catch (e) {
            // Fix error in Chrome:
    ...
    componentDidUpdate() {
        if (this.props.focusOnUpDown && this.state.focused) {
            const selectionRange = this._input.setSelectionRange;
            if (selectionRange &&
                typeof selectionRange === 'function' &&
                this.start !== undefined &&
                this.end !== undefined &&
                this.start !== this.end) {
                this._input.setSelectionRange(this.start, this.end);
            } else {
                this.focus();
            }
        }
