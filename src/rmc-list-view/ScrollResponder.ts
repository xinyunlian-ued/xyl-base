...
const ScrollResponderMixin = {
     ...
     */
    scrollResponderHandleMoveShouldSetResponderCapture: (e) => {
        return true;
    },
    ...
    scrollResponderIsAnimating: () => {
        ...
        return timeSinceLastMomentumScrollEnd < IS_ANIMATING_TOUCH_START_THRESHOLD_MS ||
     ...
     */
    scrollResponderScrollTo: (offsetX, offsetY) => {
